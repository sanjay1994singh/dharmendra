...
class Advertisement(models.Model):
    ...
    button_text = models.CharField(max_length=40, default='Call Now')
    html_code = models.TextField(blank=True)
    background_color = models.CharField(max_length=40, default='#fff9ea')
    background_color_2 = models.CharField(max_length=40, default='#fff3f0')
    border_color = models.CharField(max_length=40, default='#cf202f')
    badge_bg_color = models.CharField(max_length=40, default='#111827')
    badge_text_color = models.CharField(max_length=40, default='#ffffff')
    sponsor_text_color = models.CharField(max_length=40, default='#4b5563')
    title_color = models.CharField(max_length=40, default='#07111f')
    subtitle_color = models.CharField(max_length=40, default='#4b5563')
    contact_text_color = models.CharField(max_length=40, default='#941023')
    button_bg_color = models.CharField(max_length=40, default='#c91f2b')
    button_text_color = models.CharField(max_length=40, default='#ffffff')
